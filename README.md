...
| :--- | :--- |
| **Languages** | C#, .NET, TypeScript, JavaScript, Python, Java, C/C++, SQL, KQL, PHP |
| **Frontend** | Angular, React, Next.js, HTML/CSS (SCSS), Tailwind CSS |
| **Backend** | ASP.NET Core, Express.js, Spring Boot, Django, Flask |
| **Cloud/DevOps** | AWS (EC2, S3, Lambda, RDS), Azure, Docker, CI/CD, Git, SVN, Bamboo |
